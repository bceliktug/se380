...
import 'package:se380_project/screens/book/cinema_provider.dart';
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                if (chairRow1[index].reserveState ==
                                ...
                                if (chairRow1[index].reserveState ==
                                  ...
                                  setState(() {
                                    chairRow1[index].reserveState =
                                        ReserveState.selected;
                                  });
                                } else {
                                  setState(() {
                                    chairRow1[index].reserveState =
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                if (chairRow2[index].reserveState ==
                                    ReserveState.reserved) {
                                  return;
                                }
                                if (chairRow2[index].reserveState ==
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                if (chairRow3[index].reserveState ==
                                    ReserveState.reserved) {
                                  return;
                                }
                                if (chairRow3[index].reserveState ==
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                if (chairRow4[index].reserveState ==
                                    ReserveState.reserved) {
                                  return;
                                }
                                if (chairRow4[index].reserveState ==
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                if (chairRow5[index].reserveState ==
                                    ReserveState.reserved) {
                                  return;
                                }
                                if (chairRow5[index].reserveState ==
                                    ReserveState.available) {
                                  Provider.of<CinemaProvider>(context,
                                          listen: false)
                                      .setRowSelected("5");
                                  Provider.of<CinemaProvider>(context,
                                          listen: false)
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                if (chairRow6[index].reserveState ==
                                    ReserveState.reserved) {
                                  return;
                                }
                                if (chairRow6[index].reserveState ==
...
class SelectedSeatItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      "${cinemaProvider.selectedToString()}",
      style: TextStyle(
